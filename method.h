...
{
public:
    explicit Prim(AdjMultListNetwork& cc);
    ~Prim()=default;
    ...
    void outputPrim(int index, int tab, AdjMultListNetwork& cc, int flag);//输出树
...
void Prim::outputPrim(int index, int tab, AdjMultListNetwork& cc, int flag)
{
    if (flag)
    {
        for (int i = 0; i < tab; i++)
